	...
	<view>
		...
		<view class="b_colfff logo_bk">
			...
			<view class="u-flex" style="margin-top:40rpx;">
				...
				<view style="width: 320rpx;" class="u-text-right" @click="$tools.jump('../login/register_ph')">
					{{ $t('phoneRegister') }}</view>
			</view>

			<view style="margin-top:60rpx;">
				<view class="logo_input u-flex">
					<view>
						<image style="width: 48rpx;height: 48rpx;margin-top:10rpx;" src="../../static/images/em1.png">
						</image>
					</view>
			...
			<view class="u-text-center" style="margin-top: 30rpx; font-size: 24rpx;color: #666666;">
				{{ $t('alreadyHaveAccount') }}<text class="col35"
					@click="$tools.jump('../login/login_em')">{{ $t('loginNow') }}</text>
			</view>
		</view>
	</view>
</template>
