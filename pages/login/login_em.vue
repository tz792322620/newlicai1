<template>
	<view>
		...
		<view class="b_colfff logo_bk">
			<view class="col33 f_s36 f_bod" style="display: flex;justify-content: space-between;">{{ $t('login') }}
				<language></language>
			</view>
			<view class="u-flex" style="margin-top: 40rpx;">
				<view class="col35" style="width:320rpx;">{{ $t('emailLogin') }}</view>
				<view style="width: 320rpx;" class="u-text-right" @click="$tools.jump('../login/login_ph')">
					{{ $t('phoneLogin') }}</view>
			</view>
			<view style="margin-top:60rpx;">
				...
				<view class="u-flex" style="margin-top:30rpx;font-size: 24rpx;">
					...
					<view @click="$tools.jump('../login/password_em')" style="width: 340rpx;"
						class="u-text-right col35">
						{{ $t('forgotPassword') }}
					</view>
				</view>
			</view>
