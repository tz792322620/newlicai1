        ...
        <view style="background-image: url('../static/images/my/1.png');background-repeat: no-repeat;background-size: 100%;height:560rpx;padding:40rpx;">
            <view style="border-radius: 12rpx;background-color: #fff;padding:30rpx;margin-top: 200rpx;">
                <view class="u-flex" style="position: relative;top: -80rpx;">
					<view class="avatar" :style="`position: relative;width:188rpx;height:188rpx;border-radius: 50%;background: url(${$url + userInfo.avatar}) center center no-repeat;background-size: 100% 100%;margin-right: 30rpx;`">
                    ...
                    <view style="margin-top:60rpx;">
                        <view style="font-weight: bold;font-size: 32rpx;display: flex;align-items: center;">{{ userInfo.username }} <image v-if="userInfo.level !== 0" style="width: 36rpx;height: 36rpx;margin-left: 10rpx;" :src="`@/static/images/my/v${userInfo.level}.png`" mode=""></image> </view>
