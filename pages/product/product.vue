<template>
<<<<<<< HEAD
    <view style="background-image: url('../static/images/hm_bg.png');background-repeat: no-repeat;background-size: 100%;height: 100vh;">
...
>>>>>>> 4fe2ffab563592a2d25c019a76800884d61e4d0e
</template>
