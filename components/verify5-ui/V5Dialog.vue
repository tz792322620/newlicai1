<template>
    ...
    <div v-bind:class="mournful?popStyleM:popStyle">
        <div class="v5-wrapper">
            <div class="v5-canvas-img">
                <image v-if="!showloading" mode="aspectFit" class="v5-canvas-bg" width="260" height="160" v-bind:src="imgsrc" />
				<!-- #ifdef H5 || MP -->
                <cover-image v-if="!showloading" mode="aspectFit" class="v5-canvas-slice" ref="sliceCanvas" id="sliceCanvas" v-bind:src="slicesrc" v-bind:style="sliceStyle"/>
				<!-- #endif -->
				<!-- #ifndef H5 || MP -->
                <image v-if="!showloading" width="52" height="60" mode="aspectFit" class="v5-canvas-slice" ref="sliceCanvas" id="sliceCanvas" v-bind:src="slicesrc" :style="{left:sliceLeft+'px',top:sliceTop+'px'}"/>
				<!-- #endif -->
