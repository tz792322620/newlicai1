						...
						<view class="popup">
							...
							<div :class="isHeight?'wgSignatureq':'wgSignature'">
								<div v-if="isHeight" key="999" style="width: 750rpx ;height: 100vh;">
									<jp-signature  :beforeDelay="200" landscape disableScroll ref="signatureRef" :openSmooth="openSmooth" :penSize="6" :bounding-box="true"></jp-signature>
								</div>
								<div v-else key="888" style="width: 750rpx ;height: 35vh;">
									<jp-signature :beforeDelay="200" disableScroll ref="signatureRef" :openSmooth="openSmooth" :bounding-box="true"  :penSize="3"></jp-signature>
								</div>
